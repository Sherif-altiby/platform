...
const Aboutus = () => {
  return (
    <section className="py-24 bg-[#f9fafb]">
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 px-4 animate__animated animate__fadeIn">
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-start">
          <Image
            ...
            height={500}
            alt="about us"
            className="w-[250px] md:w-[350px] lg:w-[400px] xl:w-[500px] rounded-xl shadow-lg hover:scale-105 transition duration-300"
          />
        </div>
