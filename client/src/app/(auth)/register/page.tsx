      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
        ...
        <div className="p-8 md:p-10">
          ...
          <div className="mb-8 text-right">
            ...
            <p className="text-sm text-slate-400">أدخل بياناتك للبدء في التعلم</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-slate-600 text-right" htmlFor="name">
                  الاسم ثلاثي
                </label>
                <input
                  type="text"
                ...
                />
                {errors.name && (
                  <span className="text-xs text-red-500 text-right">{errors.name.message}</span>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-slate-600 text-right" htmlFor="phone">
                  رقم الهاتف
                </label>
                <input
                  type="number"
                ...
                />
                {errors.phone && (
                  <span className="text-xs text-red-500 text-right">{errors.phone.message}</span>
                )}
              </div>

              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-slate-600 text-right" htmlFor="level">
                  الصف الدراسي
                </label>
                <select
                  id="level"
                ...
                {errors.level && (
                  <span className="text-xs text-red-500 text-right">{errors.level.message}</span>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-slate-600 text-right" htmlFor="password">
                  كلمة المرور
                </label>
                <input
                  type="password"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-slate-600 text-right" htmlFor="pass-confirm">
                  تأكيد كلمة المرور
                </label>
                <input
                  type="password"
                ...
                {errors.confirmPassword && (
                  <span className="text-xs text-red-500 text-right">{errors.confirmPassword.message}</span>
                )}
              </div>
            </div>
