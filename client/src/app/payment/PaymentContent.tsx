...
import PayInstapay from "@/components/payment/PayInstapay";
      ...
      <div className="max-w-2xl w-full">
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
            <PaymentHeader
              title={paymenInfo?.courseTitle}
              price={paymenInfo?.coursePrice}
            />
            ...
            <div className="p-6 md:p-8 space-y-4">
              ...
              <div className="border border-slate-100 rounded-2xl overflow-hidden shadow-sm bg-white">
                <button
                  ...
                  className={`w-full p-5 flex items-center justify-between text-right transition-colors ${
                    activeAccordion === "vodafone"
                      ? "bg-slate-50/80"
                ...
                >
                  <div className="overflow-hidden">
                    <div className="p-6 bg-white">
                      <PayVodafone
                        phone={paymenInfo.vCash.number}
                        name={paymenInfo.vCash.walletName}
                        courseId={paymenInfo.courseId}
                        teacherId={paymenInfo.teacherId}
                      />
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="overflow-hidden">
                    <div className="p-6 bg-white">
                      ...
                      <PayInstapay
                        phone={paymenInfo.instaPay.number}
                        name={paymenInfo.instaPay.instaPayName}
                        courseId={paymenInfo.courseId}
                        teacherId={paymenInfo.teacherId}
                      />
                    </div>
